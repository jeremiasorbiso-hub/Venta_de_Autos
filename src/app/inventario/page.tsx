  ...
  return (
    <div style={{ background: '#0D0D0B', color: '#F5F0E8', fontFamily: 'Roboto, sans-serif', minHeight: '100vh' }}>
      ...
      <nav style={{
        ...
        <Link href="/" style={{ fontSize: '1.1rem', fontWeight: 'bold', letterSpacing: '0.12em', textTransform: 'uppercase', textDecoration: 'none', color: '#F5F0E8' }}>
      ...
      {/* Header */}
      <section style={{ padding: '3rem 2.5rem', borderBottom: '0.5px solid rgba(200,168,75,0.1)' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ fontSize: '0.68rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: '#C8A84B', fontWeight: '500', marginBottom: '0.75rem', display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            <span style={{ display: 'inline-block', width: '1.5rem', height: '0.5px', background: '#C8A84B' }}></span>
            Dossier digital
          </div>
          <h1 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.5rem)', fontWeight: '700', lineHeight: '1.1', color: '#F5F0E8', marginBottom: '1rem' }}>
            Vehículos en <span style={{ color: '#C8A84B' }}>Gestión</span>
          </h1>
          <p style={{ color: '#6B6B5E', fontSize: '0.9rem', lineHeight: '1.7' }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          {loading ? (
            ...
            <div style={{ textAlign: 'center', padding: '3rem' }}>
              <p style={{ color: '#6B6B5E', marginBottom: '1rem' }}>Sin vehículos disponibles aún</p>
              <Link href="/inventario/cargar" style={{
              ...
              {autos.map(auto => (
                <div key={auto.id} style={{
                  ...
                  <div style={{ padding: '1.25rem' }}>
                    ...
                    <div style={{ fontSize: '1.05rem', fontWeight: '700', color: '#F5F0E8', marginBottom: '0.75rem' }}>
                      {auto.modelo}
                    </div>
                    <div style={{ display: 'flex', gap: '1rem', marginBottom: '1rem' }}>
                      <div style={{ fontSize: '0.75rem', color: '#6B6B5E' }}>
                        <strong style={{ color: '#F5F0E8', display: 'block', fontSize: '0.85rem', fontWeight: '500' }}>{auto.anio}</strong>
                        Año
                      </div>
                      <div style={{ fontSize: '0.75rem', color: '#6B6B5E' }}>
                        <strong style={{ color: '#F5F0E8', display: 'block', fontSize: '0.85rem', fontWeight: '500' }}>{auto.kilometraje.toLocaleString()}</strong>
                        Km
                      </div>
                      <div style={{ fontSize: '0.75rem', color: '#6B6B5E' }}>
                        <strong style={{ color: '#F5F0E8', display: 'block', fontSize: '0.85rem', fontWeight: '500' }}>{auto.combustible}</strong>
                        Combustible
                      </div>
                    </div>
                    <div style={{ fontSize: '1.3rem', fontWeight: '700', color: '#C8A84B', marginBottom: '0.75rem' }}>
